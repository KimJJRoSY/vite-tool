...
function s(e, r = document) {
  if (typeof e != "string")
    throw new Error("getNode 함수의 인수는 문자 타입 이어야 합니다.");
  return (
    r.nodeType !== document.DOCUMENT_NODE && (r = document.querySelector(r)),
    r.querySelector(e)
  );
}
function f(e) {
...
const d = (e) => f(e) === "object",
  g = (e) => f(e) === "number";
function p(e, r) {
  typeof e == "string" && (e = s(e)), e.insertAdjacentHTML("beforeend", r);
}
s(".first");
s(".second");
const l = {
...
function m(e) {
  let r = { ...l };
  g(e) && (r.timeout = e), d(e) && (r = { ...l, ...e });
  let { timeout: n, shouldReject: c, errorMessage: t, data: o } = r;
